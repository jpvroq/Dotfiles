...
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen({ mode = "fullscreen", action = "toggle" }), { release = true })
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd("hyprshot -m region --clipboard-only"), { release = true })
-- Move focus with mainMod + arrow keys
hl.bind(mainMod .. " + left", hl.dsp.focus({ direction = "left" }))
hl.bind(mainMod .. " + right", hl.dsp.focus({ direction = "right" }))
hl.bind(mainMod .. " + up", hl.dsp.focus({ direction = "up" }))
hl.bind(mainMod .. " + down", hl.dsp.focus({ direction = "down" }))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd(ipc .. " plugin togglePanel clipper"), { release = true })
